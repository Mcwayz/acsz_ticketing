            ...
            public void onResponse(Call<TicketResponse> call, Response<TicketResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    for (Ticket ticket : tickets) {
                        ...
                        {
                            Intent intent = new Intent(CashActivity.this, MultipleTicketActivity.class);
                ...
                if(response.isSuccessful()){
                    if(response.body()!=null){
                        ...
                        try {
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<String>(CashActivity.this, R.layout.spinner_item, getTicketType);
